...
class IFormIcons extends Form{
    ...
    {
        return "<div class=\"form-group has-feedback\">{$html}</div>";
    }
     ...
     * @return string
     */
    public function input($type, $name = null, $icon, $placeholder = null)
    {
        return $this->surrond(
            '<input type="' .$type. '" name="' .$name. '" class="form-control" value="' . $this->getValue($name) . '" placeholder = "'. $placeholder .'">
