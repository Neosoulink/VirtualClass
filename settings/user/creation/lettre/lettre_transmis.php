...
Doc_archive::add([
    ...
    'name_theme' => $_POST['doc_name'],
	   'content' => $_POST['object'].','.$_POST['object_doc'],
    'get_person' => $_POST['get_user'].','.$_POST['for_persons'],
    'type_doc' => $_POST['type_doc'],
    'type_ets' => $_POST['type_ets'],
]);
$i = 0;
$nbr_achive = Doc_archive::getModel();
$array_person = preg_split("/[,]/", $_POST['for_persons']);
...
<body style="height: 100%; width: 100%;">
	...
	<div style="position: relative;padding: 2vh 3vw 0 3vw; display: inline-block;z-index: 10;width: 100%">
		<header id="header" class="">
			...
			<div class="row">
				...
				<div class="col-xs-6">
					<h4><b>N° CAB/MIN-UH/ <?= date('d') ?> / <?= date('m') ?> / <?= date('Y') ?></b></h4>
					<h4><b><u>Transmis</u> copie pour information à :</b></h4>
					<ul class="list-group" style="font-size: 1.2em;margin-left: 20px;border-bottom: 2px dashed;padding-bottom:20px;">
						<?php foreach ($array_person as $key) {
						if ($key != "") {
						?>
						<li style="padding-left: 20px">Son exelance <?= $key ?></li>
						<?php
						}} ?>
					</ul>
				</div>
				<!-- <h4 id="title_doc" style="text-transform: uppercase;text-align: center;padding-bottom: 5px;border-bottom: px solid; display: inline-block;"><?= $type_doc ?></h4> -->
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-4">
					<h4><?= $_POST['object_doc'] ?></h4>
				</div>
				<div class="col-xs-6">
					<h4 style="text-transform: uppercase;">à <?= $_POST['get_user'] ?></h4>
					<div>
						<b>KINSAHSA/GOMBE</b>
					</div>
				</div>
			</div>
			<div class="treu-content">
				
			</div>
			<div id="object_doc" style="padding : 0;font-size: 1.5em;line-height: 35px;text-align: justify;">
				<br> <div class="row">
					<div class="col-xs-6"> </div>
					<div class="col-xs-6"><?= $_POST['get_user'] ?> </div>
				</div>
				<?= $_POST['object'] ?>
			</div>
	...
	<h4 class="text-right" style="opacity: 1;margin-top: 100px; text-transform: uppercase;word-spacing: 0.3vw;white-space:"><b>Lettre adressé à <?= $_POST['get_user'] ?></b><br>
	</h4>
		</footer>
	</div>
</body>
