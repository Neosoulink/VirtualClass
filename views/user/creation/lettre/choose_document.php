<div class="x_panel">
	<div class="x_title">
  	<h2>2<sup>ème</sup> étape <small> Choisisez le Thème de ducument </small></h2>
	...
	<div class="x_content">
  	...
  	<div class="row">
    	...
    	<p>Vous pouvez selectionner un model pour y integrer votre lettre.</p>
        ...
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8 col-xs-12">
                <input type="text" name="type_doc" class="form-control" value="<?= $type_doc ?>" readonly>
              </div>
            </div>
            <div class="clearfix" style="margin-bottom: 4px"></div>

             <div class="form-group">
              <label class="control-label col-sm-4 col-xs-12">Object :</label>
              <div class="col-sm-8 col-xs-12">
                <textarea name="object_doc" class="form-control" readonly>
                  <?= $_POST['object_doc'] ?>
                </textarea>
              </div>
            </div>
            <div class="clearfix" style="margin-bottom: 4px"></div>
             ...
             <?php if ($type_doc == 'Lettre transmie en copie'): ?>
              <div class="form-group">
              <label class="control-label col-sm-4 col-xs-12">Transmie en compie :</label>
              <div class="col-sm-8 col-xs-12">
                <input type="text" name="for_persons" class="form-control" value="<?= $for_persons ?>" readonly>
              </div>
            </div>
            <div class="clearfix" style="margin-bottom: 9px"></div>
            <?php endif ?>
